...
export const BATCH_SIZE = 10; // Number of lessons will download concurrently
export const HTTP_REQUEST_TIMEOUT = 60000; // Request will timeout after this milliseconds.
